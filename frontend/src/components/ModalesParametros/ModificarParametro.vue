...
<transition name="modal-fade">
    <div class="modal-backdrop">
        ...
        <header class="modal-header">
            <strong>MODIFICAR PARAMETRO</strong>
            <button
            type="button"
            class="btn-close"
            @click="close"
        ...
        <section class="modal-body">
            ...
            <select v-model="nombre">
                    ...
                    <option value="inactividad">DIAS DE INACTIVIDAD DE USUARIO</option>
            </select>
...
export default {
    ...
    data(){
        return{
            ...
            fecha_ini : this.parametro.fecha_inicio,
            fecha_fin : this.parametro.fecha_fin,
            valor : this.parametro.valor
        }
    },
    methods:{
        ...mapActions(['modificarParametrizacion']),
        close() {
            this.$emit('close');
        },
        submitFormulario(){
            ...
            if (this.$v.$invalid){
                ...
                console.log(this.id)
                this.parametro.id = this.id
                this.parametro.nombre = this.nombre
                this.parametro.fecha_inicio = this.fecha_ini
                this.parametro.fecha_fin = this.fecha_fin
                this.parametro.valor = this.valor
                this.modificarParametrizacion(this.parametro)
                .then(() => this.$alert('Parametro modificado exitosamente','Exito','success'))
